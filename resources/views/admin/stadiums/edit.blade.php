            ...
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($stadium_data, ['url' => ['stadiums/'.$stadium_data->id.'/update'] , 'method'=>'post' ,'files'=> true]) !!}
                        ...
                        <div class="form-group row">
                            <label for="example-month-input" class="col-md-2 col-form-label">{{trans('admin.stad_name_en')}}</label>
                            <div class="col-md-10">
                               {{ Form::text('stadium_name_en',$stadium_data->name_en,["class"=>"form-control" ,"required"]) }}
                            </div>
                        </div>
                        <div class="form-group row">
