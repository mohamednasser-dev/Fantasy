...
<div class="col-lg-6 col-md-10 " style="margin-right: 30px;">
   <button data-player-id="{{$player->id}}" data-order={{$order}} data-position-name="{{$position}}" class="btn btn-danger waves-effect btn-circle add_btn-style" id="delete_home_player" name="delete_home_player" type="button">
