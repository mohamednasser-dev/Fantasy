                       ...
                       {!! Form::model($tournament_data, ['url' => ['tournaments/'.$tournament_data->id.'/update'] , 'method'=>'post' ,'files'=> true]) !!}
                        {{ csrf_field() }}
                                     ...
                                     <div class="form-group row">
                                         <label for="example-month-input" class="col-md-2 col-form-label">{{trans('admin.tour_name')}}</label>
                                    ...
                                    <div class="form-group row">
                                        <label for="example-tel-input" class="col-md-2 col-form-label">{{trans('admin.classification')}}</label>
                                        <div class="col-md-10">
